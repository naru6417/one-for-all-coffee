...
export default function Slider({ slidesPerView = 3 }: SliderProps) {
    const [current, setCurrent] = useState(0);

    // number of "pages" (each page = slidesPerView items)
    const totalSets = Math.ceil(reviewData.length / slidesPerView);
    ...
    return (
        <div className="flex justify-center items-center w-full gap-10">
            ...
            <div className="w-full overflow-hidden shadow-lg">
                ...
                const group = reviewData.slice(start, start + slidesPerView);
                ...
                return (
                    ...
                    >
                    {group.map((data, i) => (
                        <div key={data.id} className="w-full bg-white text-[var(--dark)] rounded-tl-[50px] rounded-br-[50px] p-6">
